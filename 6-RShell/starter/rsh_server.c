 ...
 *      cli_socket:  The server-side socket that is connected to the client
 *      buff:        The string buffer to send to the client
 * 
 ...
 * 
 *      ERR_RDSH_COMMUNICATION:  The send() socket call returned an error or if
 *           we were unable to send the message. 
 */
 ...
 *      clist:     The command list to execute
 * 
 *  Executes a pipeline of commands received from the client.
 * 
 *  Returns:
 * 
 *      OK:  The pipeline was executed successfully. 
 * 
 *      ERR_RDSH_COMMUNICATION:  The send() socket call returned an error or if
 *           we were unable to send the message. 
 */
